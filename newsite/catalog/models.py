...
class BookInstance(models.Model):
	...
	status = models.CharField(max_length=1, choices=LOAN_STATUS, blank=True, default='d', help_text='Availability')
...
class Author(models.Model):
		...
		date_death = models.DateField('Died in..', null = True, blank=True)
